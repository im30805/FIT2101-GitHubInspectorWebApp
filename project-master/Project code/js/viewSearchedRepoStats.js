let searchedRepoIndex = localStorage.getItem("Searched repository" + "-selectedIndex");
...
if (searchedRepoIndex !== null)
{
    repoName = getSearchedReposObj[searchedRepoIndex];
...
// data for number of lines contributed for each member
...
// data for average response time to an issue
...
// data for total time to close an issue
...
// print main developer that solved issues
